...
if __name__ == "__main__":
    ...
    learn3 = fine_tune(dls, resnet50, 5, os.path.join(MODELS_PATH, "resnet50.pkl"), tb_logs_path=os.path.join(TB_LOGS_PATH, "resnet50"))
    learn4 = fine_tune(dls, vgg19, 5, os.path.join(MODELS_PATH, "vgg19.pkl"), tb_logs_path=os.path.join(TB_LOGS_PATH, "vgg19"))
